...
function Messages({ convoId, userId, conversations, socket, arrivalMessage }) {
  ...
  }, [convoId]); // Dependency array: effect runs when convoId changes
  ...
  // console.log("revieved message is set :", arrivalMessage);
    ...
    {isLoading ? (
      ...
      messages.map((msg, index) => (
        <div
          ...
          style={{
            background:
              userId === msg.senderId ? "#1e40af" : "rgba(255, 255, 255, 0.9)",
        ...
        >
          ...
          <div className="flex flex-col break-words max-w-full">
            ...
            <div className="text-right mt-1">
              <p
                className={`text-xs ${
                  userId === msg.senderId ? "text-gray-300" : "text-gray-500"
                }`}
              >
                {msg.createdAt
